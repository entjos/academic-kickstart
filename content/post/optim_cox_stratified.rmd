...
At the end let us just compute the standard error for our estimates using the hessian matrix. For some more explanation take a look at this [previous blog post](https://www.joshua-entrop.com/post/optim_logit_reg_se/).
